...
def main():
    ...
    if args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(args.dataset_name, args.dataset_config_name, split=["train_en", "val_en", "test_en"])
    ...
    if labels_are_int:
        ...
        label_list = [ner_id_to_tag[x] for x in label_list]
        label_to_id = ner_tag_to_id
